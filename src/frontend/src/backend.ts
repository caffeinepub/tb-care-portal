...
export class Backend implements backendInterface {
    ...
    async addPatient(arg0: string, arg1: bigint, arg2: string, arg3: string): Promise<void> {
    ...
    async addResponse(arg0: string, arg1: boolean, arg2: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addResponse(arg0, arg1, arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getResponses(): Promise<Array<QuestionnaireResponse>> {
        if (this.processError) {
            try {
                const result = await this.actor.getResponses();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
